...
const openModalOrder = openModal.bind({}, 'modal-create-order');
...
const adminSection = roles.find(({name}) => name === 'admin')
    ? {
      ...
      menuItems: [
        {
          ...
          label: 'Категории заказов',
          route: '#',
          children: [{label: 'Список категорий', route: '/service-categories/'}]
        },
        {
          icon: `<svg
                  class="fill-current"
          ...
          label: 'Заказы',
          route: '#',
          children: [{label: 'Модерация заказов', route: '/admin/tasks/moderates'}]
        },
        {
          icon: `<i class="pi pi-users"></i>`,
          label: 'Пользователи',
          route: '#',
          children: [{label: 'Все пользователи', route: '/admin/users'}]
        },
      ]
    } : {};
    ...
    menuItems: [
      {
        ...
        route: '#',
        children: [
          {label: 'Мои задачи', route: '/tasks/my'},
          {label: 'Биржа проектов', route: '/tasks'},
          {label: 'Разместить задачу', route: '/tasks/create'}
        ]
      },
      {
        icon: `<svg
        ...
        label: 'Профиль',
        route: '#',
        children: [{label: 'Настройки', route: '/pages/settings'}]
      },
      {
        icon: `<svg
                  class="fill-current"
